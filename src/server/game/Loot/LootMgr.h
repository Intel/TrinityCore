...
enum LootError
{
    ...
    LOOT_ERROR_NONE                     = 17    // Everything is ok
};
...
struct Loot
{
    ...
    Loot(Object* owner, Player const* recipient, LootType type = LOOT_NONE);
    ~Loot(); 
    ...
    static Loot* CreateGameObjectLoot(GameObject* go, Player* looter);
